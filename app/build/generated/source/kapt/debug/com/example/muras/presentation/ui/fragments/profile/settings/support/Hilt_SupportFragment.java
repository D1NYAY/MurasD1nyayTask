package com.example.muras.presentation.ui.fragments.profile.settings.support;
 ...
 */
public abstract class Hilt_SupportFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SupportFragment() {
    super();
  }

  Hilt_SupportFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SupportFragment_GeneratedInjector) this.generatedComponent()).injectSupportFragment(UnsafeCasts.<SupportFragment>unsafeCast(this));
    }
  }
