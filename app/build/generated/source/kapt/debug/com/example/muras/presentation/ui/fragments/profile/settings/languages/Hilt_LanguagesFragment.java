 ...
 */
public abstract class Hilt_LanguagesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LanguagesFragment() {
    super();
  }

  Hilt_LanguagesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LanguagesFragment_GeneratedInjector) this.generatedComponent()).injectLanguagesFragment(UnsafeCasts.<LanguagesFragment>unsafeCast(this));
    }
  }
