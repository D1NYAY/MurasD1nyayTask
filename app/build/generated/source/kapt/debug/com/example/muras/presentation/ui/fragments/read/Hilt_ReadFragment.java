 ...
 */
public abstract class Hilt_ReadFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReadFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReadFragment_GeneratedInjector) this.generatedComponent()).injectReadFragment(UnsafeCasts.<ReadFragment>unsafeCast(this));
    }
  }
