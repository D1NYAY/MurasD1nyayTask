package com.example.muras.presentation.ui.fragments.profile.settings.privacy;
 ...
 */
public abstract class Hilt_PrivacyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrivacyFragment() {
    super();
  }

  Hilt_PrivacyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivacyFragment_GeneratedInjector) this.generatedComponent()).injectPrivacyFragment(UnsafeCasts.<PrivacyFragment>unsafeCast(this));
    }
  }
