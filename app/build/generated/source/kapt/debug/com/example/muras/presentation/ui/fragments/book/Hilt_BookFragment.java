 ...
 */
public abstract class Hilt_BookFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookFragment_GeneratedInjector) this.generatedComponent()).injectBookFragment(UnsafeCasts.<BookFragment>unsafeCast(this));
    }
  }
