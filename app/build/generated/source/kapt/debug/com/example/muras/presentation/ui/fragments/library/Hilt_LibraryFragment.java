 ...
 */
public abstract class Hilt_LibraryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LibraryFragment() {
    super();
  }

  Hilt_LibraryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LibraryFragment_GeneratedInjector) this.generatedComponent()).injectLibraryFragment(UnsafeCasts.<LibraryFragment>unsafeCast(this));
    }
  }
