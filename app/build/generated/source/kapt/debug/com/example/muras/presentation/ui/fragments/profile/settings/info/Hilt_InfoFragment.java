 ...
 */
public abstract class Hilt_InfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InfoFragment_GeneratedInjector) this.generatedComponent()).injectInfoFragment(UnsafeCasts.<InfoFragment>unsafeCast(this));
    }
  }
